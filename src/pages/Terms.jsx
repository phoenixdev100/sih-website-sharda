          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
              ...
              <p className="text-green-700 text-lg leading-relaxed mb-4">
                Welcome to Smart India Hackathon 2025 hosted by Sharda University. By participating in this event, you agree to comply with these terms and conditions.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 border border-green-100">
                  <h4 className="font-semibold text-green-800 mb-2">🎯 Event Purpose</h4>
                  <p className="text-green-600 text-sm">Foster innovation, collaboration, and problem-solving among students and professionals.</p>
                </div>
                <div className="bg-white rounded-lg p-4 border border-green-100">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Participation is voluntary and subject to eligibility criteria</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                ...
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-gray-700">Intellectual property rights and ownership are clearly defined</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-gray-700">Organizers reserve the right to modify terms with proper notice</span>
                </li>
              </ul>
            </div>
          </div>
