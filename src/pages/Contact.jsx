    ...
    const contactInfo = [
        {
            ...
            name: "Mr Ashish Jain",
            designation: "Professor & Internal Hackathon Lead",
            email: "hackathon.coordinator@sharda.ac.in",
            phone: "+91 120 4571000",
        ...
        },
        {
            ...
            email: "tech.support@sharda.ac.in",
            phone: "+91 120 4571001",
            office: "Tech Center, Lab 205",
        ...
        },
        {
            ...
            email: "student.affairs@sharda.ac.in",
            phone: "+91 120 4571002",
        ...
        },
        {
            ...
            name: "Ms. Neha Gupta",
            designation: "Registration Coordinator",
            email: "registration@sharda.ac.in",
            phone: "+91 120 4571003",
            office: "Admission Office, First Floor",
    ...
    const faqData = [
        {
            ...
            questions: [
                {
                    q: "When does registration open for SIH 2025?",
                    a: "Registration opens on January 15, 2025, at 12:00 PM IST and closes on February 15, 2025, at 11:59 PM IST."
                },
                {
                    q: "Can I change my team members after registration?",
                    a: "Team changes are allowed until February 10, 2025. After this date, no changes will be permitted except in exceptional circumstances."
                },
                {
                ...
                },
                {
                    ...
                    a: "No, all team members must be from the same institution as per SIH guidelines."
                }
            ]
        },
        {
            ...
            questions: [
                {
                    q: "What is the age limit for participants?",
                    a: "All team members must be under 25 years of age as of the hackathon date."
                },
                {
                    q: "Can postgraduate students participate?",
                    a: "Yes, both undergraduate and postgraduate students can participate, provided they meet the age criteria."
                },
                {
                    q: "Is work experience allowed?",
                    a: "Students with work experience can participate, but they must be currently enrolled in an academic program."
                }
            ]
        },
        {
            ...
            questions: [
                {
                    ...
                    a: "You can use any programming language, framework, or technology stack. There are no restrictions on technology choices."
                },
                {
                    q: "Will internet be provided during the hackathon?",
                    a: "Yes, high-speed internet will be available throughout the 36-hour hackathon period."
                },
                {
                    q: "Can we use pre-built components or libraries?",
                    a: "Yes, you can use existing libraries, APIs, and frameworks, but the core solution must be developed during the hackathon."
                }
            ]
        }
    ]
            ...
            <div className="mt-12 sm:mt-16">
                <div className="text-center mb-8 sm:mb-12">
                    ...
                    <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                        Need help with registration? Contact our dedicated Internal Hackathon Coordinators for assistance
                    </p>
                </div>
        ...
        <div className="space-y-6 sm:space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="rounded-lg overflow-hidden shadow-lg">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.0234567890123!2d77.4876543210987!3d28.4567890123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cc23456789abc%3A0x1234567890abcdef!2sSharda%20University!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin"
                        width="100%"
                        height="400"
                        style={{ border: 0 }}
                        allowFullScreen=""
